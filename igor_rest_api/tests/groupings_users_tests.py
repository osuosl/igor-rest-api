...
class GroupingUsersTestCase(IgorApiTestCase):
    ...
    def test_user_info(self):
        ...
        response = self.client.get(url_for('groupingsuser', username=self.test_user),
                                   headers=self.headers)
        self.assert_200(response)
    ...
    def test_nonexistent_user_info(self):
        response = self.client.get(url_for('groupingsuser', username='something'),
                                   headers=self.headers)
    ...
    def test_update_user(self):
        ...
        response = self.client.put(url_for('groupingsuser', username=self.test_user),
                                   data=data,
                                   headers=self.headers)
        self.assert_200(response)
